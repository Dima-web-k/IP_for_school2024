...
export const LoginBG = () => {
    return (
        <svg version="1.1" id="visual" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 900 600" enable-background='new 0 0 900 600'  preserveAspectRatio="none" className={style.BG}>
            <path fill='#ECA24E' d="M0,411l16.7,3.3c16.6,3.4,50,10,83.3,16s66.7,11.4,100,10.9s66.7-6.9,100-13.9s66.7-14.6,100-10.3
            ...
            <path fill='#DB934A' d="M0,451l16.7,2.5c16.6,2.5,50,7.5,83.3,9.3c33.3,1.9,66.7,0.5,100-1s66.7-3.1,100-3.8s66.7-0.3,100,1.5
            ...
            <path fill='#CA8445' d="M0,481l16.7,5.2c16.6,5.1,50,15.5,83.3,18s66.7-2.9,100-7.9s66.7-9.6,100-12.6s66.7-4.4,100-1
            ...
            <path fill='#B97640' d="M0,511l16.7,4.8c16.6,4.9,50,14.5,83.3,20.2s66.7,7.3,100,6.3s66.7-4.6,100-9c33.3-4.3,66.7-9.3,100-10.1
            ...
            <path fill='#A7683B' d="M0,571l16.7-3.8c16.6-3.9,50-11.5,83.3-14s66.7,0.1,100,4c33.3,3.8,66.7,8.8,100,8.5c33.3-0.4,66.7-6,100-10.7
